 ...
 */
final class Version20210430093833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salle CHANGE site idsite_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salle CHANGE idsite_id site INT NOT NULL');
    }
}
